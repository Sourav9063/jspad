# JS Pad: Vim-Enabled JavaScript Playground and Online Editor

**Live:** [sourav9063.github.io/jspad](https://sourav9063.github.io/jspad)

JS Pad is the first Vim-enabled JavaScript playground on the web. Powered by the same editor engine as VS Code, it runs entirely in your browser. No setup, no install, no account, just open and start writing JavaScript. A great CodePen alternative focused purely on JS.
...
- Quick JS scratchpad for testing ideas with Vim keybindings
